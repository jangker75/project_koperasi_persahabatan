...
Route::post("download-history-order", [\App\Http\Controllers\Toko\API\OrderController::class, "downloadReporthistoryorder"])->name("download.history-order");
Route::get("get-total-header-order", [\App\Http\Controllers\Toko\API\OrderController::class, "getTotalHeader"])->name("get-data-total-header-order");
Route::get('datatables-data-order', [\App\Http\Controllers\Toko\api\OrderController::class, 'getDataOrderV2'])->name("get-data-order.datatables");
