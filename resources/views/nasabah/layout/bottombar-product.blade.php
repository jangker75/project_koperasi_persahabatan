<div class="position-fixed w-100 bottom-0 left-0 p-2" style="z-index: 6;">
    <div class="bg-white border border-primary w-100 px-2 shadow p-0" style="border-radius: 8px;">
      <div class="container py-1">
          <div class="row p-0 pb-1">
              <div class="col-8 d-flex align-items-center">
                  <div class="handle-counter justify-content-start mt-2">
              ...
              <div class="col-4 d-flex align-items-center">
                  <button type="submit" id="addToCart" class="btn btn-primary w-100">Beli</button>
              </div>
          </div>
      </div>
    </div>
