        ...
        <div class="col-lg-12 col-xl-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title fw-bold">{{ str("list master data status terdaftar")->title() }}</h3>
                </div>
                <div class="card-body">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="" id="storeForm">
                                        <div class="row">
                                            <input class="form-control mb-4" name="name" placeholder="Status Baru"
                                                type="text">
                                            <input class="form-control mb-4" name="description" placeholder="Deskripsi Status"
                                                type="text">
                                            <input class="form-control mb-4" name="type" placeholder="Type"
                                                type="text">
    ...
    <script>
      $(document).ready(function () {
                ...
                function getTable() {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "{{ url('api/jquery-data-editable') }}",
                        cache: "false",
                        data: {
                            'link': "{{ $link }}",
                        },
