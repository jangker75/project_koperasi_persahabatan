...
<body>
    ...
    <section class="ketentuan">
        ...
        <ol>
            <li>Kredit barang tersebut sanggup diangsur selama 12 (Dua Belas) 24 (Dua Puluh Empat) 36 (Tiga Puluh Enam) bulan dimulai dengan angsuran
    ...
    <section class="persetujuan">
        <div class="row">
            ...
            <div class="column">
                <p class="persetujuan-title"></p>
                <p class="persetujuan-separator"></p>
                <p class="persetujuan-nip"></p>
            </div>
            <div class="column">
    ...
    <section class="syaratketentuan">
        ...
        <ul class="syaratketentuan-item" style="margin: 0px; padding-left: 13px;">
            ...
            <li>Pembayaran pinjaman melalui Payroll GajiBank Mandiri tgl 1 setiap bulannya</li>
            <li>Lampirkan Rekening koran Payroll gaji 2 bulan terakhir</li>
            <li>Rekening koran dari gaji dan Remon (Khusus P3K) masing masing 1 bulan </li>
            <li>Rekening Koran pinjaman (jika ada pinjaman di BANK MANDIRI)</li>
            <li>Untuk BLU dan Tenaga Kontrak di wajibkan memakai jaminan ijazah terakhir Asli</li>
            <li>Slip Gaji print dari AplikasiPRIMA</li>
            <li>Biaya admin bank sebesar Rp 3.330</li>
        </ul>
    </section>
